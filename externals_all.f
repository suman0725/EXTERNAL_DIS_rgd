...
cc also, all deltae_cc's are computed for Z-1, not Z!/-* 
              ...
              elseif(iA.eq.208) then !Lead	  
                 deltae_cc = 0.02035
              elseif(iA.eq.120) then !Tin (natural, avgA=118.71)
                 deltae_cc = 0.01440
              endif
...
cc also, all deltae_cc's are computed for Z-1, not Z!/-* 
	...
	elseif(iA.eq.197) then !Gold
      ...
      elseif(iA.eq.120) then !Tin (natural Sn, avgA=118.71)
           deltae_cc = 0.01440
	endif
...
! 8/9/96
      IF(IA.EQ.120)RADIUS=4.626    ! Sn-118, rms charge radius from de Vries 1987
